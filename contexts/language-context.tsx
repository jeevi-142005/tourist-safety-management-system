...
const translations = {
  ...
  ta: {
    ...
    "tabs.emergency": "அவசரநிலை+",
    "tabs.basic_emergency": "அவசரநிலை",
    ...
    "emergency.security": "பாதுகாப்பு",
    "emergency.assistance": "உதவி",
    "emergency.emergency_desc": "உடனடி உதவி தேவை",
    "emergency.medical_desc": "மருத்துவ உதவி",
    "emergency.security_desc": "பாதுகாப்பு கவலை",
  ...
  hi: {
    "header.title": "पर्यटक सुरक्षा डैशबोर्ड",
    "header.subtitle": "सुरक्षित और जुड़े रहें",
    "header.protected": "सुरक्षित",
    "header.logout": "लॉग आउट",
    "header.authority.title": "प्राधिकरण कमांड सेंटर",
    "header.authority.subtitle": "पर्यटक सुरक्षा निगरानी और प्रतिक्रिया प्रणाली",
    "header.system.operational": "सिस्टम चालू है",
    "tabs.dashboard": "डैशबोर्ड",
    "tabs.digital_id": "डिजिटल आईडी",
    "tabs.tracking": "लाइव ट्रैकिंग",
    "tabs.emergency": "आपातकाल+",
    "tabs.basic_emergency": "आपातकाल",
    "tabs.ai_assistant": "AI सहायक",
    "tabs.profile": "प्रोफ़ाइल",
    "tabs.safety": "सुरक्षा सुझाव",
    "tabs.alerts": "अलर्ट",
    "tabs.ai_anomaly": "AI पहचान",
    "emergency.title": "आपातकालीन अलर्ट",
    "emergency.emergency": "आपातकाल",
    "emergency.medical": "चिकित्सा",
    "emergency.security": "सुरक्षा",
    "emergency.assistance": "सहायता",
    "emergency.emergency_desc": "तत्काल सहायता आवश्यक",
    "emergency.medical_desc": "चिकित्सा सहायता",
    "emergency.security_desc": "सुरक्षा चिंता",
    "emergency.assistance_desc": "सामान्य सहायता",
    "emergency.send_alert": "अलर्ट भेजें",
    "emergency.cancel": "रद्द करें",
    "emergency.alert_sent": "आपातकालीन अलर्ट सफलतापूर्वक भेजा गया!",
    "emergency.alert_error": "आपातकालीन अलर्ट भेजने में विफल। कृपया पुनः प्रयास करें।",
    "status.safe": "सुरक्षित",
    "status.online": "ऑनलाइन",
    "status.offline": "ऑफलाइन",
    "status.all_systems_operational": "सभी सिस्टम चालू हैं",
    "cards.safety_status": "सुरक्षा स्थिति",
    "cards.location": "स्थान",
    "cards.connection": "कनेक्शन",
    "cards.battery": "बैटरी",
    "actions.quick_actions": "त्वरित क्रियाएं",
    "actions.emergency_assistance": "आपातकाल और सहायता विकल्प",
    "safety.tips_title": "सुरक्षा सुझाव और दिशानिर्देश",
    "safety.tips_desc": "पर्यटकों के लिए महत्वपूर्ण सुरक्षा जानकारी",
    "common.loading": "लोड हो रहा है...",
    "common.save": "सहेजें",
    "common.cancel": "रद्द करें",
    "common.loading_dashboard": "डैशबोर्ड लोड हो रहा है...",
  },
  te: {
    "header.title": "పర్యాటక భద్రతా డాష్‌బోర్డ్",
    "header.subtitle": "సురక్షితంగా మరియు అనుసంధానంగా ఉండండి",
    "header.protected": "రక్షించబడింది",
    "header.logout": "లాగ్ అవుట్",
    "header.authority.title": "అధికార కమాండ్ సెంటర్",
    "header.authority.subtitle": "పర్యాటక భద్రతా పర్యవేక్షణ మరియు ప్రతిస్పందన వ్యవస్థ",
    "header.system.operational": "సిస్టమ్ పనిచేస్తోంది",
    "tabs.dashboard": "డాష్‌బోర్డ్",
    "tabs.digital_id": "డిజిటల్ ID",
    "tabs.tracking": "లైవ్ ట్రాకింగ్",
    "tabs.emergency": "అత్యవసరం+",
    "tabs.basic_emergency": "అత్యవసరం",
    "tabs.ai_assistant": "AI సహాయకుడు",
    "tabs.profile": "ప్రొఫైల్",
    "tabs.safety": "భద్రతా చిట్కాలు",
    "tabs.alerts": "హెచ్చరికలు",
    "tabs.ai_anomaly": "AI గుర్తింపు",
    "emergency.title": "అత్యవసర హెచ్చరిక",
    "emergency.emergency": "అత్యవసరం",
    "emergency.medical": "వైద్యం",
    "emergency.security": "భద్రత",
    "emergency.assistance": "సహాయం",
    "emergency.emergency_desc": "తక్షణ సహాయం అవసరం",
    "emergency.medical_desc": "వైద్య సహాయం",
    "emergency.security_desc": "భద్రతా ఆందోళన",
    "emergency.assistance_desc": "సాధారణ సహాయం",
    "emergency.send_alert": "హెచ్చరిక పంపండి",
    "emergency.cancel": "రద్దు చేయండి",
    "emergency.alert_sent": "అత్యవసర హెచ్చరిక విజయవంతంగా పంపబడింది!",
    "emergency.alert_error": "అత్యవసర హెచ్చరిక పంపడంలో విఫలమైంది. దయచేసి మళ్ళీ ప్రయత్నించండి.",
    "status.safe": "సురక్షితం",
    "status.online": "ఆన్‌లైన్",
    "status.offline": "ఆఫ్‌లైన్",
    "status.all_systems_operational": "అన్ని సిస్టమ్‌లు పనిచేస్తున్నాయి",
    "cards.safety_status": "భద్రతా స్థితి",
    "cards.location": "స్థానం",
    "cards.connection": "కనెక్షన్",
    "cards.battery": "బ్యాటరీ",
    "actions.quick_actions": "త్వరిత చర్యలు",
    "actions.emergency_assistance": "అత్యవసర మరియు సహాయ ఎంపికలు",
    "safety.tips_title": "భద్రతా చిట్కాలు & మార్గదర్శకాలు",
    "safety.tips_desc": "పర్యాటకులకు ముఖ్యమైన భద్రతా సమాచారం",
    "common.loading": "లోడ్ అవుతోంది...",
    "common.save": "సేవ్ చేయండి",
    "common.cancel": "రద్దు చేయండి",
    "common.loading_dashboard": "డాష్‌బోర్డ్ లోడ్ అవుతోంది...",
  },
}
